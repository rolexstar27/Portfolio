...
const FloatingShape = ({ className, delay = 0, duration = 20, size = 200 }) => (
  <motion.div
    className={`absolute rounded-full opacity-[0.03] bg-primary-500 ${className}`}
...
const GridBackground = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    ...
    <div className="absolute bottom-[10%] right-[10%] w-[400px] h-[400px] rounded-full bg-accent-600/10 blur-[100px]" />
    <div className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-primary-500/5 blur-[150px]" />
  </div>
);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="mb-6">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass border-primary-500/20 text-sm text-primary-300">
            ...
            <motion.p
              variants={itemVariants}
              className="text-lg sm:text-xl text-dark-400 max-w-2xl mx-auto mb-4 text-balance leading-relaxed"
            >
            ...
            >
              ...
              <motion.a
                href="#contact"
                className="px-8 py-3.5 rounded-full glass border-dark-700/50 hover:border-primary-500/30 text-dark-200 hover:text-white font-medium text-sm transition-all duration-300"
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.97 }}
              >
                Get In Touch
            ...
            <motion.div variants={itemVariants} className="flex items-center justify-center gap-6 mb-16">
              {[
                ...
                <motion.a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-10 h-10 rounded-full glass border-dark-700/50 flex items-center justify-center text-dark-400 hover:text-primary-400 hover:border-primary-500/30 transition-all duration-300"
